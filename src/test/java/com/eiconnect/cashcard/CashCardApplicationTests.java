package com.eiconnect.cashcard;
...
class CashCardApplicationTests {
    ...
    void shouldCreateANewCashCard(){
        ...
        ResponseEntity<Void> createResponse=
                restTemplate.postForEntity("/cashcards",
        ...
        DocumentContext documentContext=
                JsonPath.parse(getResponse.getBody());
        Number id= documentContext.read("$.id");
        Double amount= documentContext.read("$.amount");
    ...
    void shouldReturnAPageOfCashCards(){
        ResponseEntity<String> response=
                restTemplate.getForEntity("/cashcards?page=0&size=1&sort=amount",String.class);
    ...
    void shouldReturnASortedPageOfCashCards(){
        ...
        double amount=
                documentContext.read("$[0].amount");
        assertThat(amount).isEqualTo(150.00);
    }
    @Test
    void shouldReturnASortedPageOfCashCardsWithNoParametersAndUseDefaultValues(){
        ResponseEntity<String> response=
                restTemplate.getForEntity("/cashcards",
                        String.class);
        assertThat(response.getStatusCode())
                .isEqualTo(HttpStatus.OK);
        DocumentContext documentContext=
